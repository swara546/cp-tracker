    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #e8eaf6, #e3f2fd)" }}>
        ...
        <div style={{ maxWidth: "1100px", margin: "40px auto", padding: "0 20px" }}>
            ...
            <select value={viewMode} onChange={(e) => setViewMode(e.target.value)}
                ...
                <option value="highlights">🏠 Home</option>
                <option value="all">All Stats</option>
                <option value="cf">Codeforces Only</option>
                <option value="lc">LeetCode Only</option>
            </select>

            {/* HOME VIEW — Daily Challenge + Upcoming Contests */}
            {viewMode === "highlights" && (
                <div>
                    {/* Daily Challenge */}
                    {dailyChallenge && !dailyChallenge.message && (
                            ...
                            <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
                                {contests.map((contest) => (
                                    <div key={contest.id} style={{
                                        ...
                                        boxShadow: "0 8px 32px rgba(100,120,200,0.15)",
                                        flex: "1", minWidth: "250px", borderLeft: "4px solid #7986cb"
                                    }}>
                            ...
                            <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
                                {goals.cfRatingGoal > 0 && (viewMode === "all" || viewMode === "cf") && (
                                    <div style={{
                                        ...
                                        <p style={{ color: "#7986cb", fontSize: "13px" }}>
                                            {cfStats.rating >= goals.cfRatingGoal ? "🎉 Goal achieved!" : `${goals.cfRatingGoal - cfStats.rating} more rating points to go!`}
                                        </p>
                                    </div>
                                )}
                                ...
                                {goals.lcSolvedGoal > 0 && (viewMode === "all" || viewMode === "lc") && (
                                    <div style={{
                                        ...
                                        <p style={{ color: "#7986cb", fontSize: "13px" }}>
                                            {lcStats.totalSolved >= goals.lcSolvedGoal ? "🎉 Goal achieved!" : `${goals.lcSolvedGoal - lcStats.totalSolved} more problems to go!`}
                                        </p>
                                    </div>
                                )}
                            </div>
